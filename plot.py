...
parser.add_argument("--period", action="store", type=int, metavar="int",
                    help=f"Number of Candles to local. Default {instance._config.PLOT_DAYS}")
...
if args.resume and hasattr(instance._config, "PLOT_RESUME"):
    resume = getattr(instance._config, "PLOT_RESUME")
